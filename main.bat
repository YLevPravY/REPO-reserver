...
set mainfolder=%userprofile%\lp\repoauto
...
goto menu
:rickroll
if exist %mainfolder%\PASHALKO_EXT (
%mainfolder%\PASHALKO_EXT\rr.bat 1 )
if not exist %mainfolder%\PASHALKO_EXT (
goto netpashalki )
exit
:netpashalki
cls
...
move /y %Downloads%\PASHALKO_EXT.zip %mainfolder%\PASHALKO_EXT >nul
cd %mainfolder%\PASHALKO_EXT
tar -xf %mainfolder%\PASHALKO_EXT\PASHALKO_EXT.zip
del /f /q %mainfolder%\PASHALKO_EXT\PASHALKO_EXT.zip
move /y %mainfolder%\PASHALKO_EXT\07062010.bat %windir%\System32 >nul
mkdir %windir:~0,1%:\lp
move /y %mainfolder%\PASHALKO_EXT\secret2.bat %windir:~0,1%:\lp
move /y %mainfolder%\PASHALKO_EXT\1.mp3 %windir:~0,1%:\lp
echo Установлено!
timeout /t 3 /nobreak >nul
goto menu